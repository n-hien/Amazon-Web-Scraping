...
def get_data(pageNo): 
    ...
    header = {'User-Agent': 'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Mobile Safari/537.36 Edg/95.0.1020.40'}
    url= 'https://www.amazon.de/s?k=earbuds&page='+str(pageNo)
    ...
    for i in soup.find_all('div',attrs={'class':['s-result-item s-asin sg-col sg-col-12-of-12 s-widget-spacing-small','s-result-item s-asin AdHolder sg-col sg-col-12-of-12 s-widget-spacing-small']}):
...
result.to_csv('amazon_products.csv', index=False, encoding='utf-8')